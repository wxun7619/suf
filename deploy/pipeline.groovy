...
def moduleNames = ['usersystem', 'domainservice', 'sufservice', 'domainservice.adminportal']
def appNames = ['usersystem', 'domainservice', 'sufservice', 'dsadminportal']
def imageurls = [
...
/* 应用程序 - 服务进程端口 */
def svcports =['9105','9107','9106','9109']
/* Kubernetes - 公共对外暴露的服务端口 */
def nodeports =['5082','5085','5087','5086']
